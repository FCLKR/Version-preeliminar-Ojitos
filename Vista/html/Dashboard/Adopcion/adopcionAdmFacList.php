                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <h3>Listado de Mascotas <a href=".\adopcionAdmCrear.php"><button class="btn btn-success">Nuevo</button></a></h3>
                        ...
                        $inc = include("Conexion.php");
                            if ($inc) {
                                if (isset($_POST["enviar"])) {
                                  ...
                                  $Result = "SELECT * FROM animales_en_adopcion WHERE nombreMascota LIKE '%$buscar%'";
