                                                            ...
                                                            if ($inc) {
                                                                if (isset($_POST["enviar"])) {
                                                                    ...
                                                                    while ($row = $buscarResult->fetch_array()) {
                                                                        ...
                                                                        $nombreCliente = $row["prinombreCliente"];
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="updateEstadocliente.php?id=<?php echo $row ['id']; ?> "><button class="btn btn-info">Cambiar</button></a></td>
                                                                            <td>    <a href="proadmlistadoEliminar.php?id=<?php echo $row ['idCliente']; ?>"><button class="btn btn-danger">Eliminar</button></a>
                                                                            </td>
                                                                        </tr> 
                                                                        <?php
                                                                    }
                                                                    ...
                                                                    if ($resultado) {
                                                                        ...
                                                                        <tr>
                                                                                            ...
                                                                                            <td ><?php echo $estadoCliente ?></td>
                                                                                            <td>
                                                                                                <a href="updateEstadocliente.php?id=<?php echo $row ['idCliente']; ?>"><button  name="Cambiar" class="btn btn-info">Cambiar</button></a></td>
                                                                                            <td> <a href="proadmlistadoEliminar.php?id=<?php echo $row ['idCliente']; ?>"><button class="btn btn-danger">Eliminar</button></a>
                                                                                            </td>
                                                                                        </tr> 
                                                                                        <?php
