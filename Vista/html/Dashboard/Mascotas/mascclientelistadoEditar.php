            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <a href=".\mascotasClienteListado.php"><button class="btn btn-success">Volver</button></a>
                ...
                <div class="box-body">
                 <div class="row">
                  <div class="col-md-12">
                    ...
                    <form action="mascclientelistadoEditarII.php" method="post">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-condensed table-hover">
                                  ...
                                  <?php 
                                   ...
                                   $query = "SELECT * FROM mascota WHERE idMascota =".$_REQUEST['id'];
                                  ...
                                  ?>  
                                    ...
                                    <tr>                                        
                                        <td><label for="nombreMascota"> Nombre Mascota</label>
                                        <input type="text" name="nombreMascota" id="nombreMascota" value="<?php echo $row['nombreMascota']; ?>"></td>
                                        
                                        <div class="form-group">
                                        <label for="sexoMascota">Sexo Mascota</label>
                                        <select name="sexoMascota" class="form-control" id="sexoMascota" value="<?php echo $row['sexoMascota']; ?>">
                                        ...
                                        <td><label for="edadMascota"> Edad</label>
                                        <input type="int" name="edadMascota" id="edadMascota" value="<?php echo $row['edadMascota']; ?>"></td>
                                        
                                        <input type="hidden" name="id" id="idMascota" value="<?php echo $_REQUEST['id']; ?>"></td>
