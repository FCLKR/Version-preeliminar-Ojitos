            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Ingresar nueva mascota</h3>
                 ...
                 <div class="row">
                     <div class="col-md-12">
                         ...
                         <h3>Especifique los siguientes datos
                             <a href=".\mascotasClienteListado.php">
                    ...
                    ?>
                         <div class="row">
                    <form action="\Ojitos\vista\html\dashboard\Mascotas\InsertnewMascota.php" method="post">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="nombreMascota" class="form-control" placeholder="Nombre..." >
                        </div>
                        <div class="form-group">
                            <label for="sexoMascota">Sexo Mascota</label>
                            <select name="sexoMascota" class="form-control">
                        ...
                        <div class="form-group">
                          <label for="descripcion">Edad Mascota</label>
                          <input type="int" name="edadMascota" class="form-control" placeholder="Edad Mascota">
                        </div>
                        <div class="form-group">
                          <a href="#">
