            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <a href=".\productosAdmListado.php"><button class="btn btn-success">Volver</button></a>
                ...
                <div class="box-body">
                 <div class="row">
                  <div class="col-md-12">
                    ...
                    <form action="proadmlistadoEditarII.php" method="post">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-condensed table-hover">
                                  ...
                                  ?>  
                                    ...
                                    <tr>                                        
                                        <td><label for="nombreProducto"> Nombre producto</label>
                                        <input type="text" name="nombreProducto" id="nombreProducto" value="<?php echo $row['nombreProducto']; ?>"></td>
                                        
                                        <td><label for="valorProducto"> Valor producto </label>
                                        <input type="text" name="valorProducto" id="valorProducto" value="<?php echo $row['valorProducto']; ?>"></td>
                                        
                                        <td><label for="stockProducto"> Cantidad</label>
                                        <input type="text" name="stockProducto" id="stockProducto" value="<?php echo $row['stockProducto']; ?>"></td>
                                        
                                        <td><label for="descripcionProducto"> Descripcion</label>
                                        <input type="text" name="descripcionProducto" id="descripcionProducto" value="<?php echo $row['descripcionProducto']; ?>"></td>
                                        <input type="hidden" name="id" id="idProducto" value="<?php echo $_REQUEST['id']; ?>"></td>
